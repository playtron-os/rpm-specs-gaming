...
BuildArch: noarch
Requires: clatd cloud-utils-growpart fio fio-engine-libaio parted python3-pygame foot google-noto-sans-mono-cjk-vf-fonts stress-ng vkmark alsa-utils powerstation upower /usr/bin/ffmpeg
...
%changelog
* Fri Mar 21 2025 Alesh Slovak <aleshslovak@gmail.com> 0.19.3-2
- Fix ffmpeg dependency causing OS build errors
